  ...
  return (
    ...
    <div className='about-content' id='abcont'>
      ...
      <div className='about-main'>
       ...
       <div className='about1'  data-aos="flip-left"><img src='./image/women2.png'></img></div>
     
       </div>
       <div className='about2'>
        <div className='ab-tag1' data-aos="zoom-in-down">Hello! I'm a developer</div>
        <div className='ab-tag2' data-aos="zoom-in">As a passionate and dedicated frontend developer, I am excited to bring my creativity and technical skills of web development. Recently graduated with a degree Bachelor of Computer Applications, I have honed my abilities in HTML, CSS, JavaScript, and modern frameworks such as React. I am looking forward to starting my professional journey and making a positive impact in a dynamic team. </div>
